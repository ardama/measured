...
import { createMeasurement, createMeasurementUnit } from "@/types/measurements";

/**
 * @typedef {import('@type/measurements').Measurement} Measurement
 * @typedef {import('@type/measurements').MeasurementType} MeasurementType
 */
...
const MeasurementList = () => {
  ...
  /**
   * @param {Measurement} editedMeasurement 
   * @returns
   */
  const handleEditMeasurement = (editedMeasurement) => dispatch(editMeasurement({
   ...
   * @returns
   */
  const handleDeleteMeasurement = (measurement) => dispatch(removeMeasurement(measurement.id));

  const handleAddMeasurement = () => dispatch(addMeasurement(createMeasurement(user, '', '', 'duration', createMeasurementUnit('minutes', 'm'), 15)));
